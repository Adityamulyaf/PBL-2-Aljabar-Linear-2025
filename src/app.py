...
def front_page():
    return render_template('index.html', byteImage = None, byteImageCompressed = None, pixelDifference = None, compressionTime = None, fileName = None)
